...
`app/` is the App Router site; `components/` holds presentation and the demo; `demo/` holds typed local scenario data; `docs/` holds product and technical decisions. GitHub Pages deploys static output from `main`; no environment variables or services are required.
